...
%% remove bad tiles
if z>200
    b_09=quantile(S,0.9,'dim',[1 2]);
    b_01=quantile(S,0.1,'dim',[1 2]);
    b_09=permute(b_09,[3 2 1]);
    b_01=permute(b_01,[3 2 1]);
    b1=quantile(b_01,0.1);
    b2=quantile(b_09,0.9);
    rm_idx1=find(b_01<b1);
    rm_idx2=find(b_09>b2);
end
rm_idx=[rm_idx1 rm_idx2];
S(:,:,rm_idx)=[];
